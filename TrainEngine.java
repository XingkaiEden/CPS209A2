...
public class TrainEngine extends Vehicle
{
    ...
    static final double U2_5 = 2.5 * UNIT ; 
    ...
    static final double U14 = 14 * UNIT ; 
	...
	{
		super();
		m_rect = new Rectangle2D.Double(getX(), getY(), U14, U5);
	}
	...
	{
		Rectangle2D.Double box = new Rectangle2D.Double(getX(), getY(), U14, U5);
